 ...
 *
 * Responsibilities:
 * - Static positioning (center, top-center, bottom-center)
 * - Focus trap (ALWAYS active)
 * - Focus first element on open (configurable via focusOnOpen prop)
 * - Backdrop support
 * - Inert background (default behavior)
 * - Scroll lock (default behavior)
 * - Semantic container with role="dialog" aria-modal="true"
 *
 * @example
