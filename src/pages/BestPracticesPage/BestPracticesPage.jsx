  ...
  return (
    <div className="best-practices-page flex justify-center">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12" aria-labelledby="wcag-principles">
          <h2 id="wcag-principles" className="text-3xl font-bold text-gray-900 mb-6 text-center">WCAG Core Principles (POUR)</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <article className="principle-card">
              <div className="icon-container best-practices mx-auto" aria-hidden="true">
                <span className="text-2xl">👁️</span>
              </div>
            ...
            <article className="principle-card">
              <div className="icon-container tools mx-auto" aria-hidden="true">
                <span className="text-2xl">⌨️</span>
              </div>
            ...
            <article className="principle-card">
              <div className="icon-container guidelines mx-auto" aria-hidden="true">
                <span className="text-2xl">🧠</span>
              </div>
              <h3 className="text-xl font-semibold mb-2">Understandable</h3>
              <p>Information and user interface operation must be understandable to all users.</p>
              <ul className="mt-3 text-sm space-y-1 text-left">
            ...
            <article className="principle-card">
              ...
              <p>Content must be robust enough to be interpreted by a wide variety of user agents and assistive technologies.</p>
              <ul className="mt-3 text-sm space-y-1 text-left">
                <li>• Valid and parseable HTML</li>
                <li>• Proper name, role, and value for all components</li>
        ...
        {/* Guidelines Section */}
        <section className="mb-12" aria-labelledby="guidelines-section">
          <h2 id="guidelines-section" className="text-3xl font-bold text-gray-900 mb-6 text-center">Standards & Guidelines</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <article className="guideline-card">
              <h3 className="text-lg font-semibold mb-3">WCAG 2.1 / 2.2</h3>
              ...
              <ul className="mt-3 text-sm space-y-1" aria-label="WCAG compliance levels">
                ...
                <li>• Level AA (standard - recommended)</li>
                <li>• Level AAA (enhanced)</li>
                <li>• WCAG 2.2 includes new criteria for mobile</li>
              </ul>
            </article>
            ...
            <article className="guideline-card">
              ...
              <ul className="mt-3 text-sm space-y-1" aria-label="ARIA topics">
                <li>• Widget patterns (menus, dialogs, tabs)</li>
                <li>• Keyboard interaction patterns</li>
                <li>• ARIA roles & properties</li>
                <li>• First rule: Don't use ARIA if HTML works</li>
              </ul>
            </article>

            <article className="guideline-card">
              <h3 className="text-lg font-semibold mb-3">Legal Standards</h3>
              <p>Various legal requirements and standards for accessibility compliance worldwide.</p>
              <ul className="mt-3 text-sm space-y-1" aria-label="Legal standards">
        ...
        <section className="mb-12" aria-labelledby="core-principles">
          <h2 id="core-principles" className="text-3xl font-bold text-gray-900 mb-6 text-center">Implementation Principles</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <article className="principle-card">
              <div className="icon-container best-practices mx-auto" aria-hidden="true">
                <span className="text-2xl">🏗️</span>
            ...
            <article className="principle-card">
              ...
              <p>Support text resizing up to 200% without loss of functionality. Ensure content reflows properly on different screen sizes.</p>
            </article>
            ...
            <article className="principle-card">
              ...
              <h3 className="text-xl font-semibold mb-2">Touch Targets</h3>
              <p>Ensure interactive elements have sufficient size (minimum 44×44 pixels) with adequate spacing between them.</p>
            </article>
            ...
            <article className="principle-card">
              ...
              <h3 className="text-xl font-semibold mb-2">Live Regions</h3>
              <p>Use ARIA live regions to announce dynamic content changes to screen reader users without moving focus.</p>
            </article>
            ...
            <article className="principle-card">
              ...
              <h3 className="text-xl font-semibold mb-2">Error Prevention</h3>
              <p>Provide confirmations for important actions. Allow users to review, correct, and reverse submissions.</p>
            </article>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <article className="testing-method">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-2" aria-hidden="true">⌨️</span> Keyboard-only Navigation
              </h3>
            ...
            <article className="testing-method">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-2" aria-hidden="true">🔊</span> Screen Reader Testing
              </h3>
              <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-12" aria-labelledby="keyboard-shortcuts">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <article className="testing-method">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-2" aria-hidden="true">⌨️</span> Basic Navigation
              </h3>
            ...
            <article className="testing-method">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-2" aria-hidden="true">🌐</span> Browser Shortcuts
              </h3>
              <ul className="list-none space-y-3">
                <li className="shortcut-item">
        ...
        <section className="mb-12" aria-labelledby="screen-reader-shortcuts">
          ...
          <article className="screen-reader-section mb-8">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🍎</span> VoiceOver (macOS/iOS - Built-in)
              </h3>
              <p className="text-gray-700 mb-4">
                <strong>VO (VoiceOver modifier key)</strong> is a combination of keys used for all VoiceOver commands. 
                On Mac, VO = <kbd className="mx-1">Ctrl + Option</kbd>. For example, "VO + A" means press Ctrl, Option, and A together.
              </p>
            </div>
          ...
          <article className="screen-reader-section mb-8">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🔊</span> NVDA (Windows - Free)
              </h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
          ...
          <article className="screen-reader-section mb-8">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🔊</span> JAWS (Windows - Commercial)
              </h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
          ...
          <article className="screen-reader-section mb-8">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🐧</span> Orca (Linux - Free)
              </h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
          ...
          <article className="screen-reader-section mb-8">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🤖</span> TalkBack (Android - Built-in)
              </h3>
            </div>
          ...
          <article className="screen-reader-section">
            <div className="screen-reader-header">
              <h3 className="text-2xl font-semibold mb-4 flex items-center">
                <span className="text-2xl mr-3" aria-hidden="true">🌐</span> ChromeVox (Chrome Extension - Free)
              </h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
