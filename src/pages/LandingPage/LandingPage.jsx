...
const workshopCards = [
  ...
  {
    title: "Ex 4: Cart Modal Accessibility (Watch & Learn / Take Home)",
    description: "Improved Dialog Overlay modal usecase with focus trap and better accessibility.",
    playground: "/playground/cart-modal",
    solved: "/solved/cart-modal",
  },
  {
    title: "Ex 5: Page Level Accessibility",
    description: "Improved handling of page level issues with accessibility in mind.",
    playground: "/playground/page-level",
    solved: "/solved/page-level",
  },
];
