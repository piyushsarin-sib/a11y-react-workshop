...
const SearchAndFilter = ({ onSearchChange, onFilterChange }) => {
  ...
  const filterOptions = [
    { type: 'category', id: 'hearing', name: 'Hearing Assistance', emoji: '👂', group: 'Categories' },
    { type: 'category', id: 'vision', name: 'Visual Assistance', emoji: '👁️', group: 'Categories' },
    { type: 'category', id: 'mobility', name: 'Mobility Aids', emoji: '🦽', group: 'Categories' },
    { type: 'category', id: 'sensory', name: 'Sensory Tools', emoji: '🧸', group: 'Categories' },
    { type: 'price', id: 'under1000', name: 'Under ₹1,000', emoji: '💰', group: 'Price Ranges' },
    { type: 'price', id: '1000-5000', name: '₹1,000 - ₹5,000', emoji: '💰', group: 'Price Ranges' },
    { type: 'price', id: 'above5000', name: 'Above ₹5,000', emoji: '💰', group: 'Price Ranges' },
  ];
