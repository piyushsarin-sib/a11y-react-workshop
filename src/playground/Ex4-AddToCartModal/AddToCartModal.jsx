...
const AddToCartModal = () => {
  // ✅ STEP 1: Configure useDialog hook for a Dialog overlay for modal
  ...
  return (
    <>
      <Checkpoints />
      {/* ✅ STEP 2: Connect trigger button to dialog controls by spreading trigger props and onClick handler */}
      <Button
        {...dialogState.trigger}
      ...
      {/* ✏️ TODO STEP 3: Configure DialogOverlay component with dialog state props */}
      ...
      <div id="add-to-cart-modal" className="mb-4">
